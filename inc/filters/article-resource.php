	...
	<article <?php post_class(); ?>>									
      ...
      <div class="col-12 col-md-2 offset-md-1">
        <ul class="access">
					...
					<li><a href="<?php echo get_stylesheet_directory_uri(); ?>/create-endnote-enw-file.php?publication_id=<?php echo $resource_id; ?>" target="_blank"><?php _e( 'Tagged', 'socialwork');?></a></li>
					<li><a href="<?php echo get_stylesheet_directory_uri(); ?>/create-endnote-xml-file.php?publication_id=<?php echo $resource_id; ?>" target="_blank" ><?php _e( 'XML', 'socialwork');?></a></li>
				</ul>
      </div>
